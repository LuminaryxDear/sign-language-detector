...
const SignLanguageApp = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-violet-950 text-white flex flex-col">
      {/* Header */}
      <div className="max-w-7xl mx-auto mb-6 w-full px-4 md:px-6">
      ...
      {/* Main Content */}
      <div className="max-w-7xl mx-auto flex-grow w-full px-4 md:px-6">
                  ...
                  {holdProgress > 0 ? (
                    ...
                    <div>
                      <div className="flex justify-between text-xs text-gray-300 mb-2">
                        ...
                        <span>
                          {((1 - cooldownProgress) * 100).toFixed(0)}%
                        </span>
                      </div>
      ...
      {/* Footer Copyright */}
      <footer className="mt-auto py-6 text-center text-sm text-gray-500 border-t border-white/10 bg-black/30 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4">
          © 2026 DearIsLuminar. All rights reserved.
        </div>
      </footer>
    </div>
  );
